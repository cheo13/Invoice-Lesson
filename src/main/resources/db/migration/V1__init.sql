...
-- Vista para mostrar información detallada de la factura junto con el cliente y detalles del producto
    CREATE OR REPLACE VIEW invoice_detail_customer_product AS
